...
namespace MeteoStorm.Daemon.Jobs
{
  ...
  {
    private readonly ILogger<GatherMeteoDataJob> _logger;
    private readonly MeteoStormDbContext _dbContext;
    private readonly IWeatherClient _weatherClient;

    public GatherMeteoDataJob(ILogger<GatherMeteoDataJob> logger, MeteoStormDbContext dbContext,
    ...
    public async Task Execute(IJobExecutionContext context)
    {
      ...
      {
        _logger.LogError(e, "GatherMeteoDataJob resulted in error");
      }
    }
  }
}